...
export const getAllTypes = async (_req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, "Lấy danh sách loại bất động sản thành công", types);
  } catch (error: any) {
...
export const createType = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, "Tạo loại bất động sản mới thành công", newType);
  } catch (error: any) {
    return errorResponse(res, error.message);
  }
};
...
export const updateType = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res, "Cập nhật loại bất động sản thành công", updatedType);
  } catch (error: any) {
    return errorResponse(res, error.message);
  }
};
