    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            >
                ...
                <Typography variant="h5" sx={{ fontFamily: 'Akaya Telivigala, cursive' }} className='text-center py-2 text-blue-500 font-bold'>
                    Dwello
                </Typography>
                <Typography variant="h6" className='text-center text-xl text-gray-300 pb-3 italic'>
                        ...
                        <Box key={item.text}>
                            <ListItem disablePadding className='text-white'>
                                ...
                                >
                                    ...
                                    {item.text === 'List User' ? (open ? <ExpandLess /> : <ExpandMore />) : null}
                                </ListItemButton>
                            </ListItem>
            ...
            >
                <Toolbar /> {/* tạo khoảng trống bằng chiều cao AppBar (nếu có sau này) */}
                <Outlet></Outlet>
