  ...
  .init(
    {
      debug: true,
      resources,
      ns: ['home', 'properties', 'propertyPage', 'createPropertyPage', 'addressAutocomplete', 'propertyDetail', 'properties', 'listProperties', 'detailProperty'],     //add các namespace khi viết thêm ở trên vào mảng này
      defaultNS,
      fallbackLng: 'en',
      detection: {
